/**
 * @Author: Fabre Ed
 * @Date:   2017-12-17T12:07:16-05:00
 * @Email:  edwidgefabre@gmail.com
 * @Filename: script.js
 * @Last modified by:   Fabre Ed
 * @Last modified time: 2017-12-17T15:47:57-05:00
 */
...
var torus,
  ...
  disk,
  ring,
  cube; // basic objects, created using function createModel
...
function world() {
  ...
  pushMatrix();
  mat4.translate(modelview, modelview, [-0.7, .7, 0]);
  mat4.scale(modelview, modelview, [0.2, 0.2, 0.2]);
  mat4.rotate(modelview, modelview, (45) / 180 * Math.PI, [0, .5, 1]);
  tree();
  popMatrix();

  // Adding Vehicles
  pushMatrix();
  mat4.rotate(modelview, modelview, (-frameNumber) / 90 * Math.PI, [-1, 1,
    0
  ]);
  mat4.rotate(modelview, modelview, (90) / 180 * Math.PI, [1, 1, 0]);
